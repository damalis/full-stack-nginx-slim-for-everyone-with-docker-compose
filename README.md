...
<p align="left">
<a href="https://www.slimframework.com/" target="_blank" rel="noreferrer"> <img src="https://avatars.githubusercontent.com/u/11195762?s=200&v=4" alt="Slim" height="40" width="40"/> </a>&nbsp;&nbsp;&nbsp; 
...
The containers are now built and running. You should be able to access the Slim installation with the configured IP in the browser address. `https://DOMAIN_NAME`.
